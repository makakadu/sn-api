    ...
    $app->add(new JwtAuthentication([
        ...
        "rules" => [
            new MyRequestPathRule([
                'path' => '/',                               
                'ignore' => [
                    ['uri' => "/api/users/\w+$", 'method' => 'GET'],
                    ['uri' => "/api/users/\w+/posts", 'method' => 'GET'],
                    ['uri' => "/api/user-posts/\w+", 'method' => 'GET'],
                    ['uri' => "/api/user-post-comments/\w+", 'method' => 'GET'],
                    ['uri' => "/profile-pictures/\w+", 'method' => 'GET'],
//                    ['uri' => "/user-albums/\w+", 'method' => 'GET'],
//                    ['uri' => "/auth/me", 'method" => 'GET'],
                    ['uri' => "/api/auth/login", 'method' => 'POST'],
                    ['uri' => "/api/auth/signup", 'method' => 'POST'],
//                    ['uri' => "/test"],
